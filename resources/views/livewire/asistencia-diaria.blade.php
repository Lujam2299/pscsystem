        ...
        <div class="container mx-auto max-w-7xl">
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
                ...
                <div class="border-b border-gray-200 dark:border-gray-700 pb-6 mb-6">
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        ...
                        <div class="flex items-center space-x-2">
                            @if (session('success'))
                                <div
                                    class="bg-green-100 border-l-4 border-green-500 rounded-r text-green-900 px-4 py-3 shadow-md">
                ...
                @if ($punto)
                    ...
                    @if ($asistenciaExiste)
                        <div
                            class="mb-6 p-4 bg-green-100 dark:bg-green-900/30 border border-green-200 dark:border-green-800 rounded-lg">
                    ...
                    @else
                        <div
                            class="mb-6 p-4 bg-yellow-100 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-800 rounded-lg">
                            <div class="flex items-center">
                                    ...
                                    <div class="p-5">
                                        ...
                                        <div class="space-y-3">
                                            ...
                                            <div
                                                ...
                                                <label for="asistencia_{{ $usuario->id }}"
                                                    class="text-sm font-medium text-gray-700 dark:text-gray-300">
                                                    Asistió
                                                </label>
                                                <input type="checkbox" wire:model="elementosEnlistados"
                                                    value="{{ $usuario->id }}" id="asistencia_{{ $usuario->id }}"
                                            ...
                                            <div class="flex items-center justify-between">
                                                <label for="falta_{{ $usuario->id }}"
                                                    class="text-sm font-medium text-gray-700 dark:text-gray-300">
                                                    Faltó
                                                </label>
                                                <input type="checkbox" wire:model="faltas" value="{{ $usuario->id }}"
                                            ...
                                            <!-- Descansó -->
                                            <div class="flex items-center justify-between">
                                                <label for="descanso_{{ $usuario->id }}"
                                                    class="text-sm font-medium text-gray-700 dark:text-gray-300">
                                                    Descansó
                                                </label>
                                                <input type="checkbox" wire:model="descansos"
                                                    value="{{ $usuario->id }}" id="descanso_{{ $usuario->id }}"
