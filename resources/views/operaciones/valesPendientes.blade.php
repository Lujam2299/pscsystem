            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        <div>
                            <h1 class="text-2xl font-bold text-gray-900 dark:text-white flex items-center">
                                ...
                                Vales Pendientes de Comprobación
                            </h1>
                            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                Vales aceptados que requieren comprobación de gastos
                            </p>
                        </div>
                ...
                @if($vales->isEmpty())
                    <div class="text-center py-12">
                        ...
                        <p class="text-gray-500 dark:text-gray-400">No se encontraron vales que requieran comprobación de gastos.</p>
                    </div>
                @else
                                    ...
                                    @foreach($vales as $vale)
                                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                                <a href="{{ route('vales.comprobantes.formulario', $vale->id) }}"
