<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
                ...
                <div class="border-b border-gray-200 dark:border-gray-700 pb-6 mb-6">
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        ...
                        <div class="flex items-center space-x-2">
                            <div
                                class="bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-200 px-3 py-1 rounded-full">
                ...
                @if ($errors->any())
                    <div class="mb-6 bg-red-100 border-l-4 border-red-500 rounded-r text-red-900 px-4 py-3 shadow-md"
                        role="alert">
                        <div class="flex">
                ...
                <form action="{{ route('vales.comprobantes.subir', $vale->id) }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf

                    <div id="comprobantes-container">
                        <div
                            class="comprobante-item flex flex-wrap gap-4 mb-4 p-4 border border-gray-200 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-700/30">
                            ...
                            <div class="w-full mb-3">
                                ...
                                <div class="relative">
                                    ...
                                    <div
                                        class="resultados-usuarios absolute z-10 mt-1 w-full bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg shadow-lg max-h-60 overflow-auto hidden">
                                    </div>
                                </div>
                                <div
                                    class="usuario-seleccionado mt-2 flex items-center bg-blue-50 dark:bg-blue-900/20 px-3 py-2 rounded-lg hidden">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="h-4 w-4 text-blue-600 dark:text-blue-400 mr-2" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                                    </svg>
                                    ...
                                    <button type="button"
                                        class="ml-2 text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 limpiar-usuario">×</button>
                                </div>
                            </div>
                            ...
                            <div class="flex items-end">
                                <button type="button" onclick="removeComprobante(this)"
                    ...
                    <button type="button" onclick="addComprobante()"
                        class="mb-6 inline-flex items-center px-3 py-2 bg-gray-600 hover:bg-gray-700 text-white text-xs rounded-lg transition duration-200 shadow-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 mr-1" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <script>
        function addComprobante() {
            ...
            newItem.className =
                'comprobante-item flex flex-wrap gap-4 mb-4 p-4 border border-gray-200 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-700/30';
            newItem.innerHTML = `
            <div class="w-full mb-3">
        ...
        function mostrarResultadosEnElemento(usuarios, resultadosDiv) {
            ...
            usuarios.forEach(usuario => {
                ...
                div.className =
                    'px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 cursor-pointer text-sm text-gray-900 dark:text-white';
                div.textContent = usuario.name;
                div.onclick = () => {
                    // Encontrar los elementos correspondientes
                    const busquedaInput = resultadosDiv.closest('.comprobante-item').querySelector(
                        '.busqueda-usuario');
                    const usuarioIdInput = resultadosDiv.closest('.comprobante-item').querySelector(
                        '.usuario-id');
                    const usuarioSeleccionadoDiv = resultadosDiv.closest('.comprobante-item').querySelector(
                        '.usuario-seleccionado');
                    const nombreUsuarioSpan = resultadosDiv.closest('.comprobante-item').querySelector(
                        '.nombre-usuario');
