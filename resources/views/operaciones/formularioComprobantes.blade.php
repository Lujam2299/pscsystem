        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
                ...
                <form action="{{ route('vales.comprobantes.subir', $vale->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="comprobante-item flex flex-wrap gap-4 mb-4 p-4 border border-gray-200 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-700/30">
                            <div class="flex-1 min-w-[200px]">
                                ...
                                <input type="file" name="archivos[]" accept=".pdf,.jpg,.jpeg,.png" required
                                       class="block w-full text-sm text-gray-900 border border-gray-300 dark:border-gray-600 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400">
                            </div>
                    ...
                    <button type="button" onclick="addComprobante()" class="mb-6 inline-flex items-center px-3 py-1.5 bg-gray-600 hover:bg-gray-700 text-white text-xs rounded-lg transition duration-200 shadow-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
