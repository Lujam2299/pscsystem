@php
    ...
    $cards = [
        // --- GESTIÓN CRÍTICA (ALTAS Y BAJAS) ---
        [
            'titulo' => 'Nuevas Altas Pendientes',
            'ruta' => route('aux.nuevasAltas'),
            'icono' => 'user-plus',
            'theme' => 'emerald',
            'notificaciones' => $conteoAltas,
            'desc' => 'Altas sin acuse IMSS registrado'
        ],
        [
            ...
            'icono' => 'user-x',
            'theme' => 'rose',
            'desc' => 'Gestión de bajas y finiquitos IMSS'
        ],
        [
            'titulo' => 'Historial Acuses Alta',
            'ruta' => route('aux.historialAcusesAlta'),
            'icono' => 'history',
            'theme' => 'emerald',
            'variant' => 'soft',
            'desc' => 'Registro de altas procesadas'
        ],
        [
            'titulo' => 'Historial Acuses Baja',
            'ruta' => route('aux.historialAcuseBajas'),
            'icono' => 'archive',
            'theme' => 'rose',
            'variant' => 'soft',
            'desc' => 'Registro de bajas procesadas'
        ],

        // --- ADMINISTRACIÓN Y CONFRONTAS ---
        [
            'titulo' => 'Confrontas IMSS/INFONAVIT',
            'ruta' => route('aux.confrontas'),
            'icono' => 'files',
            'theme' => 'blue',
            'desc' => 'Validación de cuotas obrero-patronales'
        ],
        [
            ...
            'icono' => 'user-edit',
            'theme' => 'indigo',
            'desc' => 'Modificar salarios y datos afiliatorios'
        ],
        [
            ...
            'theme' => 'amber',
            'desc' => 'Generación y consulta de cédulas'
        ],
        [
            'titulo' => 'Historial de Cédulas',
            'ruta' => route('aux.historialCedulas'),
            'icono' => 'folder-open',
            'theme' => 'amber',
            'variant' => 'soft',
            'desc' => 'Respaldo documental'
        ],

        // --- SIPARE Y RIESGOS DE TRABAJO ---
        [
            'titulo' => 'SIPARE',
        ...
        [
            'titulo' => 'Historial SIPARE',
            'ruta' => route('aux.historialSipare'),
            'icono' => 'list-checks',
            'theme' => 'violet',
            'variant' => 'soft',
            'disabled' => true,
            'desc' => 'Consultas históricas'
        ],
        [
            ...
            'theme' => 'orange',
            'desc' => 'Reporte de accidentes laborales'
        ],
        [
            'titulo' => 'Historial Riesgos',
            'ruta' => route('aux.historialRiesgosTrabajo'),
            'icono' => 'clipboard-list',
            'theme' => 'orange',
            'variant' => 'soft',
            'desc' => 'Bitácora de incidentes'
        ],

        // --- INCAPACIDADES ---
        [
            'titulo' => 'Incapacidades Activas',
            'ruta' => route('aux.incapacidadesList'),
            'icono' => 'bandage',
            'theme' => 'red',
            'desc' => 'Gestión de subsidios IMSS'
        ],
        [
            'titulo' => 'Historial Incapacidades',
            'ruta' => route('aux.historialIncapacidades'),
            'icono' => 'activity',
            'theme' => 'red',
            'variant' => 'soft',
            'desc' => 'Registro médico-laboral'
        ],

        // --- ANALÍTICA Y USUARIO ---
        [
            'titulo' => 'Gráficos y Estadísticas',
            'ruta' => route('auxadmin.index'),
            'icono' => 'chart-bar',
            'theme' => 'cyan',
            'desc' => 'Métricas de gestión IMSS'
        ],
        [
            ...
            'icono' => 'id-badge',
            'theme' => 'slate',
            'desc' => 'Datos personales y afiliación'
        ],
        [
    ...
    function getImssThemeClasses($theme, $isHover = false) {
        $colors = [
...
<div class="col-span-full">
    ...
    <div class="mb-6">
        <h2 class="text-xl font-bold text-gray-800 dark:text-white">Módulo IMSS</h2>
        <p class="text-sm text-gray-500 dark:text-gray-400">Gestión de seguridad social, confrontas y riesgos de trabajo</p>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        @foreach($cards as $card)
            @php
                ...
                $baseClasses = getImssThemeClasses($theme);
                $hoverClasses = getImssThemeClasses($theme, true);
